    ...
    init() {
        ...
        const goDeposit = () => {
            if (CONFIG.DEPOSIT_LINK) {
                ...
                // Ensure deposit tab is active
                const tabs = document.querySelectorAll('.wallet-tabs button');
