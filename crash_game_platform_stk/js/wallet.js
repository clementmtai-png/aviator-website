const Wallet = {
    ...
    async openPesapalPayment() {
        ...
        const email = Auth.currentUser ? Auth.currentUser.email || (Auth.currentUser.username + '@example.com') : 'customer@example.com';
        const phone = Auth.currentUser ? Auth.currentUser.phone || Auth.currentUser.username : '';
        ...
        // Disable hardcoded STK to allow redirection to Pesapal page
        const isStk = false;
